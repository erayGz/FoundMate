...
export function ApplicationsSummary({ goal }: { goal: CollaborationGoal }) {
  ...
  const latest = [...applications].sort((a, b) => (b.updatedAt ?? b.createdAt).localeCompare(a.updatedAt ?? a.createdAt))[0];
